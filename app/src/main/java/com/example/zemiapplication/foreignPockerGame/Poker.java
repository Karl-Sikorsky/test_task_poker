package com.example.zemiapplication.foreignPockerGame;
...
public class Poker {
    ...
    public String getPrizeString(int result) {
        if (result == 0) return "No pair";
        else if (result == 1) return "1 pair";
        else if (result == 2) return "2 pair";
        else if (result == 3) return "3 card";
        else if (result == 4) return "Full house\n";
        else if (result == 5) return "4 card\n";
        else if (result == 6) return "5 card\n";
        else return "No pair\n";
    }

    public static String getWinner(int myResult, int yourResult) {
        if (myResult > yourResult) return "You win.\n";
        else if (myResult == yourResult) return "It is a draw\n";
